...
class GorillaDataset(Dataset):  # pylint: disable=too-few-public-methods
    ...
    def __init__(
        self, dataset: str, dataset_path: str, tokenizer: AutoTokenizer, use_stag: bool, use_jf: bool = True
    ) -> None:
...
def create_dataset(  # pylint: disable=too-many-return-statements,too-many-branches
    ...
    if args.dataset in SUPPORTED_DATASET:
        ...
        return GorillaDataset(args.dataset, args.dataset_path, tokenizer, args.use_stag, args.use_jf)
